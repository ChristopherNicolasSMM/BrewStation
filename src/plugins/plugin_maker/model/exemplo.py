"""
Modelo de exemplo para o plugin maker.
...
- Se table_prefix for null no install.json, a tabela será criada como "plugin_maker_exemplo"
...
class MakerExemplo(db.Model):
    ...
    """
    __tablename__ = 'exemplo'  # Será prefixado automaticamente para "plugin_maker_exemplo"
    ...
    def __repr__(self):
        return f'<MakerExemplo(id={self.id}, nome="{self.nome}")>'
