"""
Modelo de exemplo para o plugin device_manager.
...
- Se table_prefix for null no install.json, a tabela será criada como "plugin_device_manager_exemplo"
...
class DeviceManagerExemplo(db.Model):
    """
    Modelo de exemplo.
    ...
    """
    __tablename__ = 'exemplo'  # Será prefixado automaticamente para "plugin_device_manager_exemplo"
    ...
    def __repr__(self):
        return f'<DeviceManagerExemplo(id={self.id}, nome="{self.nome}")>'
