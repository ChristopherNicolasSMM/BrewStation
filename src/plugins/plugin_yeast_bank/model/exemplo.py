"""
Modelo de exemplo para o plugin yeast_bank.
...
- Se table_prefix for null no install.json, a tabela será criada como "plugin_yeast_bank_exemplo"
...
class YeastBankExemplo(db.Model):
    """
    Modelo de exemplo.
    ...
    """
    __tablename__ = 'exemplo'  # Será prefixado automaticamente para "plugin_yeast_bank_exemplo"
    ...
    def __repr__(self):
        return f'<YeastBankExemplo(id={self.id}, nome="{self.nome}")>'
