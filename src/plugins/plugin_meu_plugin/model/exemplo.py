"""
Modelo de exemplo para o plugin meu_plugin.
...
- Se table_prefix for null no install.json, a tabela será criada como "plugin_meu_plugin_exemplo"
...
class MeuExemploExemplo(db.Model):
    """
    Modelo de exemplo.
    ...
    """
    __tablename__ = 'exemplo'  # Será prefixado automaticamente para "plugin_meu_plugin_exemplo"
    ...
    def __repr__(self):
        return f'<MeuExemploExemplo(id={self.id}, nome="{self.nome}")>'
